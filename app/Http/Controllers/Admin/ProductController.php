...
class ProductController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $products = Product::select('id', 'name', 'price', 'selling_price', 'created_at')
    ...
    {
        $data = $request->only('name', 'description', 'status', 'brand_id', 'category_id', 'price', 'quantity', 'barcode', 'sku', 'is_featured');
