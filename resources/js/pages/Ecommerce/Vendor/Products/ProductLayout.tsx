                        ...
                        <Card className="sticky top-4 border-none bg-white shadow-xl dark:bg-gray-800">
                            <CardContent className="p-0">
                                ...
                                <nav className="flex flex-col space-y-1 p-2">
                                    <Link
                                        href={route('vendor.products.edit', productId)}
                                        className={cn(
                                    ...
                                    <Link
                                        href={route('vendor.products.images.index', productId)}
                                        className={cn(
                                            'flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all',
                                            activeTab === 'images'
                                                ? 'bg-primary/10 text-primary dark:hover:bg-gray-800'
                                    ...
                                    {/* <Link
                                        href={route('vendor.products.variation-types.index', productId)}
                                        className={cn(
                                            'flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all',
                                    ...
                                    {/* <Link
                                        href={route('vendor.products.variations.index', productId)}
                                        className={cn(
                                            'flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all',
