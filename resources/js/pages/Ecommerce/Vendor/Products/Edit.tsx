...
export default function Edit({ product, categories, brands }: Props) {
    ...
    return (
        <ProductLayout
            ...
            backUrl={route('vendor.products.index')}
        ...
        >
            <div className="p-4">
                <form onSubmit={handleSubmit}>
                                        ...
                                        config={{
                                            ...
                                            defaultMode: 1,
                                             style: {
                                                ...
                                                // 💥 Force styles inside the actual iframe/document
                                                iframeCSS: `
                                                    body {
                    ...
                    {/* Action Buttons */}
                    <div className="mt-8 flex items-center justify-center md:justify-end gap-2 md:gap-4 border-t pt-6">
