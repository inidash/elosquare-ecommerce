...
export default function ProductImages({ product, images }: { product: Product; images: ProductImage[] }) {
    ...
    console.log('Initial images:', productImages);
    useEffect(() => {
    ...
    const handleUpload = () => {
        ...
        setIsUploading(true);
        router.post(route('vendor.products.images.store', product.id), formData, {
            onProgress: (progress) => {
    ...
    const handleDelete = (imageId: number) => {
        router.delete(route('vendor.products.images.destroy', imageId), {
            onSuccess: () => {
    ...
    return (
        <ProductLayout
            ...
            backUrl={route('vendor.products.edit', product.id)}
                        ...
                        >
                            ...
                            {isDragActive ? (
                                ...
                                <>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Supports: JPG, PNG, GIF, WEBP (Max: 5MB)</p>
                                </>
                            )}
                        </div>
                    </div>
