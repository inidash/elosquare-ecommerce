                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select disabled value={data.category_id} onValueChange={(value) => setData('category_id', value)}>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select disabled value={data.brand_id} onValueChange={(value) => setData('brand_id', value)}>
                                    <SelectTrigger className="h-12 w-full dark:border-gray-600 dark:bg-gray-800/80">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select disabled value={data.status} onValueChange={(value) => setData('status', value)}>
                                    <SelectTrigger className="h-12 w-full dark:border-gray-600 dark:bg-gray-800/80">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={data.is_featured} onValueChange={(value) => setData('is_featured', value)}>
                                    <SelectTrigger className="h-12 w-full dark:border-gray-600 dark:bg-gray-800/80">
                                        <SelectValue placeholder="Select status" />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div className="group relative">
                                <div className="prose prose-sm dark:prose-invert w-full max-w-none">
                                    <JoditEditor
                                        ...
                                        config={{
                                            readonly: true,     // 🔒 makes the editor disabled
